...
export class CompaniesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param limit Number of items to include in the page
     */
    public async getV2CompaniesFields(
        cursor?: string,
        limit?: number,
        _options?: Configuration,
    ): Promise<RequestContext> {
     ...
     * @param limit Number of items to include in the page
     */
    public async getV2CompaniesIdListEntries(
        id: number,
        cursor?: string,
        limit?: number,
        _options?: Configuration,
     ...
     * @param limit Number of items to include in the page
     */
    public async getV2CompaniesIdLists(
        id: number,
        cursor?: string,
        limit?: number,
        _options?: Configuration,
...
export class CompaniesApiResponseProcessor {
     ...
     */
    public async getV2CompaniesWithHttpInfo(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2CompaniesFieldsWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2CompaniesIdWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2CompaniesIdListEntriesWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2CompaniesIdListsWithHttpInfo(
        response: ResponseContext,
