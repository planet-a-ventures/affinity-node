...
export class OpportunitiesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getV2Opportunities(
        cursor?: string,
        limit?: number,
        ids?: Array<number>,
     ...
     */
    public async getV2OpportunitiesId(
        id: number,
        _options?: Configuration,
    ): Promise<RequestContext> {
        let _config = _options || this.configuration
...
export class OpportunitiesApiResponseProcessor {
     ...
     */
    public async getV2OpportunitiesWithHttpInfo(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2OpportunitiesIdWithHttpInfo(
        response: ResponseContext,
