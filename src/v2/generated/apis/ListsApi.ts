...
export class ListsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param limit Number of items to include in the page
     */
    public async getV2ListsListidFields(
        listId: number,
        cursor?: string,
        limit?: number,
        _options?: Configuration,
     ...
     */
    public async getV2ListsListidListEntries(
        listId: number,
        cursor?: string,
        limit?: number,
        ...
        if (fieldTypes !== undefined) {
            requestContext.setQueryParam(
                ...
                ObjectSerializer.serialize(
                    fieldTypes,
                    "Array<'enriched' | 'global' | 'list' | 'relationship-intelligence'>",
                    'string',
                ),
            )
        }
     ...
     * @param limit Number of items to include in the page
     */
    public async getV2ListsListidSavedViews(
        listId: number,
        cursor?: string,
        limit?: number,
        _options?: Configuration,
     ...
     */
    public async getV2ListsListidSavedViewsViewid(
        listId: number,
        viewId: number,
        _options?: Configuration,
    ): Promise<RequestContext> {
     ...
     * @param limit Number of items to include in the page
     */
    public async getV2ListsListidSavedViewsViewidListEntries(
        listId: number,
        viewId: number,
        cursor?: string,
        limit?: number,
...
export class ListsApiResponseProcessor {
     ...
     */
    public async getV2ListsWithHttpInfo(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2ListsListidWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2ListsListidFieldsWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2ListsListidListEntriesWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2ListsListidSavedViewsWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2ListsListidSavedViewsViewidWithHttpInfo(
        response: ResponseContext,
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async getV2ListsListidSavedViewsViewidListEntriesWithHttpInfo(
        response: ResponseContext,
    ): Promise<HttpInfo<ListEntryWithEntityPaged>> {
        const contentType = ObjectSerializer.normalizeMediaType(
            response.headers['content-type'],
