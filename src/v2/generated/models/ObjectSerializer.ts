...
export * from '../models/EmptyMessageBodyError.ts'
...
export * from '../models/InvalidAcceptHeaderError.ts'
export * from '../models/InvalidMessageBodyError.ts'
export * from '../models/InvalidVersionHeaderError.ts'
...
export * from '../models/TooManyMultipartFilesError.ts'
...
} from '../models/DropdownValue.ts'
import {
    DropdownsValue,
    DropdownsValueTypeEnum,
} from '../models/DropdownsValue.ts'
...
} from '../models/InteractionValue.ts'
...
} from '../models/OpportunityListEntry.ts'
...
} from '../models/PersonListEntry.ts'
...
} from '../models/RankedDropdownValue.ts'
...
let typeMap: { [index: string]: any } = {
    ...
    'Email': Email,
    'EmptyMessageBodyError': EmptyMessageBodyError,
    'Errors': Errors,
    'Field': Field,
    ...
    'InvalidVersionHeaderError': InvalidVersionHeaderError,
    'List': List,
    'ListEntry': ListEntry,
    ...
    'TooManyMultipartFilesError': TooManyMultipartFilesError,
    'User': User,
...
const mimeTypePredicateFactory = (
    predicate: (descriptor: MimeTypeDescriptor) => boolean,
): MimeTypePredicate =>
(mimeType) => predicate(parseMimeType(mimeType))
...
const isJsonLikeMimeType = mimeTypePredicateFactory((descriptor) =>
        ...
        if (data == undefined) {
            ...
            for (let date of data) {
                transformedData.push(
                    ObjectSerializer.serialize(date, subType, format),
                )
            }
